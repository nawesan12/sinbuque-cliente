...
class _ChatMenuState extends State<_ChatMenu> {
  ...
  @override
  Widget build(BuildContext context) {
    // SinBuque no muestra el chat: cuando manejamos una máquina estamos hablando por teléfono
    // con la persona, y un chat que nadie mira es un botón que ocupa lugar en la barra.
    //
    // Se devuelve un widget vacío en vez de sacar la clase: así el resto del archivo —y la
    // llamada a la voz, que sigue estando— no se entera de nada.
    return const Offstage();
  }

  // ignore: unused_element
  Widget buildChatMenuOriginal(BuildContext context) {
    if (isWeb) {
