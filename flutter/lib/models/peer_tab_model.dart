...
class PeerTabModel with ChangeNotifier {
  ...
  // SinBuque deja **una sola** pestaña: las sesiones recientes.
  //
  // Las otras cuatro —favoritos, equipos descubiertos en la red, libreta de direcciones y
  // dispositivos accesibles— no las usamos, y las tres últimas encima necesitan una cuenta
  // en la nube de RustDesk, que no tenemos ni queremos: son puertas que sólo sirven para que
  // alguien se pierda.
  //
  // Se apagan acá, en la lista de habilitadas, y no borrando el enum: la barra dibuja
  // únicamente `visibleEnabledOrderedIndexs`, así que con esto desaparecen de la interfaz sin
  // tocar las cien referencias que hay repartidas por el resto del código.
